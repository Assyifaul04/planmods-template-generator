  ...
  return (
    <div className="px-4 lg:px-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button
          onClick={() => router.push("/admin/activity/stats")}
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <div className="flex-1 min-w-[200px] relative">
          ...
          <Input
            placeholder="Search activities by action or user..."
            value={search}
            ...
            {loading ? (
              ...
              activities.map((activity) => (
                <TableRow key={activity.id} className="border-white/10 hover:bg-white/5">
                  ...
                  <TableCell>
                    <div className="max-w-[200px] truncate text-white/60 text-sm">
                      {activity.metadata ? (
          ...
          <div className="py-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-white/60">{selectedActivity?.ipAddress || "N/A"}</p>
              </div>
              <div>
                <p className="text-sm text-white/40">User Agent</p>
                <p className="text-white/60 text-sm break-all">{selectedActivity?.userAgent || "N/A"}</p>
              </div>
            </div>
